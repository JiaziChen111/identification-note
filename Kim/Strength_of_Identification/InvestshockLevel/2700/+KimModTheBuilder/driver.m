...
M_.exo_names(2) = {'epsupsilon'};
M_.exo_names_tex(2) = {'{\varepsilon^\upsilon}'};
M_.exo_names_long(2) = {'investement-specific technology shock'};
...
M_.endo_names(9) = {'upsilon'};
M_.endo_names_tex(9) = {'{\upsilon}'};
M_.endo_names_long(9) = {'investement-specific technology'};
...
M_.param_names(10) = {'UPSILONBAR'};
M_.param_names_tex(10) = {'{\bar{\upsilon}}'};
M_.param_names_long(10) = {'steady state investment specific technology'};
M_.param_names(11) = {'RHOUPSILON'};
M_.param_names_tex(11) = {'{\rho_\upsilon}'};
M_.param_names_long(11) = {'persistence investment specific technology shock'};
M_.param_names(12) = {'SIGUPSILON'};
M_.param_names_tex(12) = {'{\sigma_\upsilon}'};
M_.param_names_long(12) = {'standard deviation investment specific technology shock'};
...
M_.dynamic_tmp_nbr(2) = 26; % Number of temporaries used for the evaluation of g1 (jacobian)
...
RHOA = M_.params( 6 );
M_.params( 11 ) = 0.5;
RHOUPSILON = M_.params( 11 );
RHOR        = 0.5;          
M_.params( 7 ) = 0.6;
SIGA = M_.params( 7 );
M_.params( 12 ) = 0.6;
SIGUPSILON = M_.params( 12 );
SIGR        = 0.2;          
PIEA        = 3.2;          
PIEBAR      = 1+PIEA/400;   
PSIPIE      = 1.5;          
...
weakresults_hessian = (diag(oo_.posterior.optimization.Variance).*2700).^(-1)';
options_.TeX = true;
...
var_list_ = {};
oo_recursive_=dynare_estimation(var_list_);
weakresults_mcmc = (diag(oo_.posterior.metropolis.Variance).*2700).^(-1)';
collect_latex_files;
