...
g1(2,3)=y(6)*T(29)*(T(1)*T(2)-y(3)*(T(2)*T(31)+T(1)*T(32)))/(T(1)*T(2)*T(1)*T(2))-T(17)*(-(y(5)*params(3)))/(y(3)*y(3))*T(33);
g1(2,5)=(-(T(17)*T(33)*params(3)/y(3)));
g1(2,6)=T(12)-T(18)*y(7)*T(16);
g1(2,7)=(-(T(18)*y(6)*T(16)));
g1(3,4)=(-(y(6)*T(10)));
g1(3,6)=y(7)-T(10)*(y(4)+y(7)*(1-params(3)));
g1(3,7)=y(6)-y(6)*T(10)*(1-params(3));
g1(4,3)=(-(params(3)*T(13)/params(3)*getPowerDeriv(y(3)*T(13)/params(3),1-params(9),1)*T(34)));
