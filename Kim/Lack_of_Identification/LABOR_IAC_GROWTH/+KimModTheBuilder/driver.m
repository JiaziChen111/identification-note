...
M_.param_names(10) = {'GAMMAL'};
M_.param_names_tex(10) = {'{\gamma_L}'};
M_.param_names_long(10) = {'labor weight in utility'};
...
M_.dynamic_tmp_nbr(2) = 33; % Number of temporaries used for the evaluation of g1 (jacobian)
M_.dynamic_tmp_nbr(3) = 9; % Number of temporaries used for the evaluation of g2 (hessian)
...
M_.static_tmp_nbr(3) = 19; % Number of temporaries used for the evaluation of g2 (hessian)
...
WBAR = (1-ALPHA)*ABAR*(KSBAR_o_LBAR)^ALPHA; 
M_.params( 10 ) = LAMBAR*WBAR*(1-LBAR);
GAMMAL = M_.params( 10 );
%
% SHOCKS instructions
%
