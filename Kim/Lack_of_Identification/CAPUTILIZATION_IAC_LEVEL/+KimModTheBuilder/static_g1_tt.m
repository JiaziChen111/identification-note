...
T(56) = (-(y(5)*params(3)))/(y(3)*y(3));
T(57) = getPowerDeriv(y(5)*params(3)/y(3),params(9),1);
T(58) = params(3)*T(14)/params(3)*getPowerDeriv(y(3)*T(14)/params(3),1-params(9),1);
T(59) = getPowerDeriv(T(23),1/(1-params(9)),1);
T(60) = (-((y(3))*(-T(1))))/(((y(1))-T(1)*(y(5)))*((y(1))-T(1)*(y(5))));
T(61) = (-T(60));
T(62) = (-(y(2)*T(61)))/((1-T(2))*(1-T(2)));
T(63) = T(29)*T(62);
T(64) = (-(y(3)*T(60)))/(T(2)*T(2));
T(65) = T(31)*T(64);
T(66) = T(24)*T(61)+(1-T(2))*T(63)+T(25)*T(60)+T(2)*T(65);
T(67) = T(33)*T(66);
T(68) = (-(y(2)*(T(3)*T(61)+(1-T(2))*T(67))))/T(35);
T(69) = (-(y(3)*(T(3)*T(60)+T(2)*T(67))))/T(38);
T(70) = (1-params(3))*getPowerDeriv(y(5),1-params(9),1);
T(71) = getPowerDeriv(T(8),params(1),1);
T(72) = getPowerDeriv(T(8),params(1)-1,1);
