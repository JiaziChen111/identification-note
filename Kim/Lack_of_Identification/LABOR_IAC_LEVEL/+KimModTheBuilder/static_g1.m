...
g1(2,3)=y(6)*T(40)*T(54)-T(19)*T(55)*T(56);
g1(2,5)=(-(T(19)*T(56)*params(3)/y(3)));
g1(2,6)=T(12)-T(20)*y(7)*T(18);
...
g1(5,9)=(-(y(8)*T(66)));
g1(6,4)=1;
g1(6,5)=(-(y(8)*params(1)*T(62)*T(63)));
g1(6,8)=(-T(15));
g1(6,9)=(-(y(8)*params(1)*T(63)*T(67)));
g1(7,1)=1-T(35);
g1(7,2)=(-T(43));
g1(7,3)=(-T(52));
...
g1(9,10)=y(6);
g1(10,5)=(-(y(8)*(1-params(1))*T(62)*T(64)));
g1(10,8)=(-T(17));
g1(10,9)=(-(y(8)*(1-params(1))*T(64)*T(67)));
g1(10,10)=1;
if ~isreal(g1)
