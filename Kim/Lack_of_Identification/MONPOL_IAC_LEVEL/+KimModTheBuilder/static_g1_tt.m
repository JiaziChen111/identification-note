...
T(60) = (-(y(5)*params(3)))/(y(3)*y(3));
T(61) = getPowerDeriv(y(5)*params(3)/y(3),params(9),1);
T(62) = params(3)*T(14)/params(3)*getPowerDeriv(y(3)*T(14)/params(3),1-params(9),1);
T(63) = getPowerDeriv(T(21),1/(1-params(9)),1);
T(64) = (1-params(3))*getPowerDeriv(y(5),1-params(9),1);
T(65) = getPowerDeriv(T(7),params(1),1);
T(66) = params(1)*getPowerDeriv(T(7),params(1)-1,1);
T(67) = getPowerDeriv(y(9),params(13),1);
T(68) = 1/T(8)*getPowerDeriv(y(10)/T(8),params(11),1);
T(69) = (y(9))*T(68);
