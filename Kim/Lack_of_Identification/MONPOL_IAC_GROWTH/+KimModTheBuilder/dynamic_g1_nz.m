...
% Returns the coordinates of non-zero elements in the Jacobian, in column-major order, for each lead/lag (only for endogenous)
  ...
  nzij_pred(7,1)=10; nzij_pred(7,2)=9;
  ...
  nzij_current(13,1)=1; nzij_current(13,2)=6;
  nzij_current(14,1)=2; nzij_current(14,2)=6;
  ...
  nzij_current(23,1)=10; nzij_current(23,2)=9;
  nzij_current(24,1)=10; nzij_current(24,2)=10;
  ...
  nzij_fwrd(6,1)=9; nzij_fwrd(6,2)=6;
  nzij_fwrd(7,1)=2; nzij_fwrd(7,2)=7;
  nzij_fwrd(8,1)=3; nzij_fwrd(8,2)=7;
  nzij_fwrd(9,1)=9; nzij_fwrd(9,2)=10;
end
