...
T(50) = (-(y(5)*params(3)))/(y(3)*y(3));
T(51) = getPowerDeriv(y(5)*params(3)/y(3),params(9),1);
T(52) = params(3)*T(13)/params(3)*getPowerDeriv(y(3)*T(13)/params(3),1-params(9),1);
T(53) = getPowerDeriv(T(19),1/(1-params(9)),1);
T(54) = (1-params(3))*getPowerDeriv(y(5),1-params(9),1);
T(55) = getPowerDeriv(T(7),params(1),1);
T(56) = params(1)*getPowerDeriv(T(7),params(1)-1,1);
