...
M_.param_names(10) = {'ETAC'};
M_.param_names_tex(10) = {'{\eta^c}'};
M_.param_names_long(10) = {'consumption utility parameter'};
...
M_.static_tmp_nbr(2) = 37; % Number of temporaries used for the evaluation of g1 (jacobian)
...
estim_params_.param_vals = [estim_params_.param_vals; 10, 2, 1e-8, 10, 3, 2, 0.3, NaN, NaN, NaN ];
steady;
resid;                  
