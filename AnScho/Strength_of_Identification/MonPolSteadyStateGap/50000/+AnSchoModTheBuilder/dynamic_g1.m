...
g1 = zeros(9, 20);
g1(1,9)=T(22);
g1(1,15)=(-(y(10)*T(7)*T(23)/y(16)/(T(9)*y(17))));
...
g1(2,9)=(-(1/params(5)*(-(T(22)/T(3)*getPowerDeriv(T(6)/T(3),(-1),1)))-T(7)*params(14)*y(16)*(y(16)-T(11))*y(14)*(-(T(8)*T(22)))/(T(6)*T(6))/y(8)));
g1(2,15)=T(7)*params(14)*y(16)*(y(16)-T(11))*y(14)*T(23)/T(6)/y(8);
...
g1(4,8)=(-(T(20)*T(19)*(steady_state(6))*(y(11)/T(1))^params(6)*1/(steady_state(4))*getPowerDeriv(T(14),params(7),1)*T(21)));
g1(4,2)=(-(T(20)*T(18)*getPowerDeriv(y(2),params(8),1)));
g1(4,10)=1;
g1(4,11)=(-(T(20)*T(19)*T(21)*T(14)^params(7)*(steady_state(6))*1/T(1)*getPowerDeriv(y(11)/T(1),params(6),1)));
