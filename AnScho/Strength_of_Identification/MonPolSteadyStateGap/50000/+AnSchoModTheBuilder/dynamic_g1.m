...
g1(2,9)=(-(1/params(5)*(-(T(22)*getPowerDeriv(T(6),(-1),1)))+T(7)*params(14)*y(16)*(y(16)-T(11))*y(14)*(-(T(8)*T(22)))/(T(6)*T(6))/y(8)));
g1(2,15)=(-(T(7)*params(14)*y(16)*(y(16)-T(11))*y(14)*T(23)/T(6)/y(8)));
g1(2,11)=(-(params(14)*(y(11)-T(10))+y(11)*params(14)-params(14)/(2*params(5))*2*(y(11)-T(11))));
