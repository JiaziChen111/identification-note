...
g1(2,10)=(-(1/params(5)*(-(T(24)*getPowerDeriv(T(7),(-1),1)))+T(8)*params(14)*y(17)*(y(17)-T(12))*y(15)*(-(T(9)*T(24)))/(T(7)*T(7))/y(9)));
g1(2,16)=(-(T(8)*params(14)*y(17)*(y(17)-T(12))*y(15)*T(25)/T(7)/y(9)));
g1(2,3)=(-(y(12)*params(14)*T(26)));
g1(2,12)=(-(params(14)*(y(12)-T(11))+y(12)*params(14)-params(14)/(2*params(5))*(1-T(27))*2*(y(12)-T(12))+T(8)*params(14)*y(17)*T(15)*(-T(27))));
