...
g1 = zeros(9, 21);
g1(1,10)=T(24);
g1(1,16)=(-(y(11)*T(8)*T(25)/y(17)/(T(10)*y(18))));
...
g1(2,10)=(-(1/params(5)*(-(T(24)/T(4)*getPowerDeriv(T(7)/T(4),(-1),1)))-T(8)*params(14)*y(17)*(y(17)-T(12))*y(15)*(-(T(9)*T(24)))/(T(7)*T(7))/y(9)));
g1(2,16)=T(8)*params(14)*y(17)*(y(17)-T(12))*y(15)*T(25)/T(7)/y(9);
g1(2,3)=(-(y(12)*params(14)*T(26)-params(14)/(2*params(5))*T(26)*2*(y(12)-T(11))));
g1(2,12)=(-(params(14)*(y(12)-T(11))+y(12)*params(14)-params(14)/(2*params(5))*2*(y(12)-T(11))-T(8)*params(14)*y(17)*T(16)*(-(T(21)*getPowerDeriv(y(12),params(16),1)))));
g1(2,17)=T(8)*params(14)*(T(16)*(y(17)-T(12))+y(17)*T(16));
g1(3,9)=1-T(15)*params(14)/2-(1-1/y(13));
g1(3,10)=(-1);
g1(3,3)=(-(y(9)*params(14)/2*T(26)*2*(y(12)-T(11))));
g1(3,12)=(-(y(9)*params(14)/2*2*(y(12)-T(11))));
g1(3,13)=(-(y(9)*(-((-1)/(y(13)*y(13))))));
g1(4,9)=(-(T(19)*T(18)*T(20)*1/T(2)*T(22)*T(23)));
g1(4,2)=(-(T(19)*T(17)*getPowerDeriv(y(2),params(8),1)));
g1(4,11)=1;
g1(4,12)=(-(T(19)*T(18)*T(23)*(y(9)/T(2))^params(7)*(steady_state(6))*1/T(1)*getPowerDeriv(y(12)/T(1),params(6),1)));
g1(4,13)=(-(T(19)*T(18)*T(23)*T(20)*T(22)*(-((1-params(5))^(1/params(4))*y(9)))/(T(2)*T(2))));
g1(4,19)=(-(T(17)*T(18)*params(11)/100*T(19)));
