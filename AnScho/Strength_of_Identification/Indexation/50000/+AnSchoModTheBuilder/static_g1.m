...
g1(2,7)=(-(params(14)*(y(7)-T(11))+y(7)*params(14)*T(25)-params(14)/(2*params(5))*T(25)*2*(y(7)-T(11))-T(8)*params(14)*(T(17)+y(7)*T(16)*T(25))));
g1(3,4)=1-T(15)*params(14)/2-(1-1/y(8));
g1(3,5)=(-1);
g1(3,7)=(-(y(4)*params(14)/2*T(25)*2*(y(7)-T(11))));
g1(3,8)=(-(y(4)*(-((-1)/(y(8)*y(8))))));
g1(4,4)=(-(exp(params(11)*x(1))*T(19)*(y(6))*T(20)*1/T(2)*T(22)*T(23)));
g1(4,6)=1-exp(params(11)*x(1))*(T(19)*T(23)*T(20)*T(21)+T(18)*getPowerDeriv(y(6),params(8),1));
g1(4,7)=(-(exp(params(11)*x(1))*T(19)*T(23)*T(21)*(y(6))*1/T(1)*getPowerDeriv(y(7)/T(1),params(6),1)));
g1(4,8)=(-(exp(params(11)*x(1))*T(19)*T(23)*(y(6))*T(20)*T(22)*(-((1-params(5))^(1/params(4))*y(4)))/(T(2)*T(2))));
