...
residual(1) = lhs - rhs;
lhs = 1;
rhs = 1/params(5)*(1-(T(7)/T(4))^(-1))+y(12)*params(14)*(y(12)-T(11))-params(14)/(2*params(5))*T(15)-T(8)*params(14)*y(17)*T(16)*(y(17)-T(12));
residual(2) = lhs - rhs;
lhs = y(9)-y(9)*T(15)*params(14)/2;
rhs = y(10)+y(9)*(1-1/y(13));
residual(3) = lhs - rhs;
lhs = y(11);
rhs = T(17)*T(18)*exp(params(11)*x(it_, 1));
residual(4) = lhs - rhs;
lhs = log(y(13));
rhs = (1-params(9))*log(T(14))+params(9)*log(y(4))+params(12)*x(it_, 2);
residual(5) = lhs - rhs;
lhs = log(y(14));
