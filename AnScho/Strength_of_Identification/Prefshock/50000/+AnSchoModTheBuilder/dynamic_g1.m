...
g1 = zeros(10, 24);
g1(1,10)=T(22);
g1(1,17)=(-(y(11)*T(7)*T(24)/y(18)/(T(9)*y(19))));
...
g1(2,10)=(-(1/params(5)*(-(T(22)/y(15)*T(23)))-T(7)*params(14)*y(18)*(y(18)-T(11))*y(16)*(-(T(8)*T(22)))/(T(6)*T(6))/y(9)));
g1(2,17)=T(7)*params(14)*y(18)*(y(18)-T(11))*y(16)*T(24)/T(6)/y(9);
g1(2,12)=(-(params(14)*(y(12)-T(10))+y(12)*params(14)-params(14)/(2*params(5))*2*(y(12)-T(10))));
g1(2,18)=T(7)*params(14)*(T(16)+y(18)*T(15));
g1(2,15)=(-(1/params(5)*(-(T(23)*(T(3)*y(15)-T(6))/(y(15)*y(15))))-T(7)*params(14)*y(18)*(y(18)-T(11))*y(16)*(-(T(3)*T(8)))/(T(6)*T(6))/y(9)));
...
g1(4,9)=(-(exp(params(11)*x(it_, 1))*T(18)*T(19)*1/T(2)*T(20)*T(21)));
g1(4,2)=(-(exp(params(11)*x(it_, 1))*T(17)*getPowerDeriv(y(2),params(8),1)));
g1(4,11)=1;
g1(4,12)=(-(exp(params(11)*x(it_, 1))*T(18)*T(21)*(y(9)/T(2))^params(7)*(steady_state(6))*1/T(1)*getPowerDeriv(y(12)/T(1),params(6),1)));
g1(4,13)=(-(exp(params(11)*x(it_, 1))*T(18)*T(21)*T(19)*T(20)*(-((1-params(5))^(1/params(4))*y(9)))/(T(2)*T(2))));
g1(4,21)=(-(T(17)*T(18)*params(11)*exp(params(11)*x(it_, 1))));
