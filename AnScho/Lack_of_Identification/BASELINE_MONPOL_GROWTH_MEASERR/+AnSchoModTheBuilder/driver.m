...
M_.param_names(16) = {'SIGYGR'};
M_.param_names_tex(16) = {'{\sigma_{YGR}}'};
M_.param_names_long(16) = {'standard deviation measurement errors YGR'};
M_.param_names(17) = {'SIGINFL'};
M_.param_names_tex(17) = {'{\sigma_{INFL}}'};
M_.param_names_long(17) = {'standard deviation measurement errors INFL'};
M_.param_names(18) = {'SIGINT'};
M_.param_names_tex(18) = {'{\sigma_{INT}}'};
M_.param_names_long(18) = {'standard deviation measurement errors INT'};
...
M_.params = NaN(18, 1);
M_.NNZDerivatives = [39; 92; -1; ];
M_.static_tmp_nbr = [7; 10; 2; 0; ];
M_.params( 1 ) = 1;
RA = M_.params( 1 );
M_.params( 2 ) = 3.2;
PA = M_.params( 2 );
...
estim_params_.param_vals = [estim_params_.param_vals; 16, 0.23, 1e-8, 5, 4, 0.3, 2, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 17, 0.56, 1e-8, 5, 4, 0.3, 2, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 18, 0.66, 1e-8, 5, 4, 0.3, 2, NaN, NaN, NaN ];
steady;
resid;                  
