...
\hline
$[\psi_\pi \psi_y \rho_R \sigma_R ]$ & err & $[\psi_\pi \rho_R \sigma_R ]$ & ${\pi},{\zeta}$ \\
\hline
...
\hline
$\checkmark\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${YGR},{R},{g}$ \\
\hline
...
\hline
$[\psi_y ]$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${INFL},{INT},{z}$ \\
\hline
...
\hline
$[\psi_y ]$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${INFL},{R},{\zeta}$ \\
\hline
...
\hline
$\checkmark\checkmark$ & err & $\checkmark$ & ${y},{R},{\pi}$ \\
\hline
...
\hline
$\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${y},{z},{\zeta}$ \\
\hline
...
\hline
$\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${c},{R},{\zeta}$ \\
\hline
...
\hline
$\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${c},{z},{\zeta}$ \\
\hline
