...
estim_params_.param_vals = [estim_params_.param_vals; 12, 0.2, 1e-8, 5, 4, 0.3, 4, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 13, 0.6, 1e-8, 5, 4, 0.4, 4, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 14, 0.3, 1e-8, 5, 4, 0.4, 4, NaN, NaN, NaN ];
...
estim_params_.param_vals = [estim_params_.param_vals; 19, 0.2, 1e-8, 5, 4, 0.3, 4, NaN, NaN, NaN ];
steady;
resid;                  
