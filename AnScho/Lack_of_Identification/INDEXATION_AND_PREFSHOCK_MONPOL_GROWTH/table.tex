...
\hline
$[\psi_\pi \psi_y \rho_R \sigma_R ]$ & err & $\checkmark$ & ${c},{\zeta}$ \\
\hline
...
\hline
$[\psi_\pi \psi_y \rho_R \sigma_R ]$ & err & $[\sigma_R ]$ & ${\pi},{\zeta}$ \\
\hline
...
\hline
$\checkmark\checkmark$ & err & $[\psi_\pi \rho_R ]$ & ${YGR},{R},{g}$ \\
\hline
...
\hline
$\checkmark\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${INFL},{INT},{R}$ \\
\hline
$\checkmark\checkmark$ & err & $[\psi_\pi \psi_y ]$ & ${INFL},{INT},{\pi}$ \\
\hline
$\checkmark\checkmark$ & err & $[\psi_\pi \psi_y ]$ & ${INFL},{INT},{g}$ \\
\hline
$\checkmark\checkmark$ & err & $[\psi_\pi \psi_y ]$ & ${INFL},{INT},{z}$ \\
\hline
$\checkmark\checkmark$ & err & $[\psi_\pi \psi_y ]$ & ${INFL},{INT},{\zeta}$ \\
\hline
...
\hline
$\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${INT},{z},{\zeta}$ \\
\hline
...
\hline
$\checkmark\checkmark$ & err & $[\psi_\pi \rho_R \sigma_R ]$ & ${R},{\pi},{g}$ \\
\hline
$\checkmark\checkmark$ & err & $[\rho_R \sigma_R ]$ & ${R},{\pi},{z}$ \\
\hline
$\checkmark\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${R},{\pi},{\zeta}$ \\
\hline
$\checkmark$ & err & $[\psi_\pi \psi_y \rho_R ]$ & ${R},{g},{z}$ \\
\hline
$\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${R},{g},{\zeta}$ \\
\hline
$\checkmark$ & err & $[\psi_\pi \psi_y \rho_R ]$ & ${R},{z},{\zeta}$ \\
\hline
...
\hline
\caption{INDEXATION AND PREFSHOCK MONPOL GROWTH}
