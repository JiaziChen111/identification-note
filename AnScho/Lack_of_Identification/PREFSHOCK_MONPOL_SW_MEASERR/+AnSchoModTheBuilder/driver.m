...
M_.param_names(19) = {'SIGYGR'};
M_.param_names_tex(19) = {'{\sigma_{YGR}}'};
M_.param_names_long(19) = {'standard deviation measurement errors YGR'};
M_.param_names(20) = {'SIGINFL'};
M_.param_names_tex(20) = {'{\sigma_{INFL}}'};
M_.param_names_long(20) = {'standard deviation measurement errors INFL'};
M_.param_names(21) = {'SIGINT'};
M_.param_names_tex(21) = {'{\sigma_{INT}}'};
M_.param_names_long(21) = {'standard deviation measurement errors INT'};
...
M_.params = NaN(21, 1);
M_.NNZDerivatives = [47; 140; -1; ];
M_.static_tmp_nbr = [9; 27; 4; 0; ];
M_.params( 1 ) = 1;
RA = M_.params( 1 );
M_.params( 2 ) = 3.2;
PA = M_.params( 2 );
...
estim_params_.param_vals = [estim_params_.param_vals; 19, 0.23, 1e-8, 5, 4, 0.3, 2, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 20, 0.56, 1e-8, 5, 4, 0.3, 2, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 21, 0.66, 1e-8, 5, 4, 0.3, 2, NaN, NaN, NaN ];
steady;
resid;                  
