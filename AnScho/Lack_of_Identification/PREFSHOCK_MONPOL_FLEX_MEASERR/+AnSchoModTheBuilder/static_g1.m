...
g1 = zeros(10, 10);
g1(1,5)=y(10)*T(30)-y(6)*T(7)*T(5)*T(30)/y(7)/(T(9)*y(9));
...
g1(2,5)=(-(T(14)*(-(T(31)*T(32)))-T(7)*params(14)*y(7)*T(33)));
g1(2,7)=(-(params(14)*(y(7)-T(10))-T(7)*params(14)*T(16)));
g1(2,10)=(-(T(14)*(-(T(32)*T(40)))-T(7)*params(14)*y(7)*T(41)));
g1(3,4)=1-T(15)*params(14)/2-(1-1/y(8));
g1(3,5)=(-1);
g1(3,8)=(-(y(4)*(-T(37))));
g1(4,4)=(-(T(19)*T(18)*T(28)*T(29)));
g1(4,6)=1-T(19)*(T(18)*T(29)*T(24)*T(25)+T(17)*T(34));
g1(4,7)=(-(T(19)*T(18)*T(29)*T(25)*T(36)));
g1(4,8)=(-(T(19)*T(18)*T(29)*(y(6))*T(24)*T(39)));
