...
T(29) = y(14)*(-y(9))/(y(1)*y(1));
T(30) = getPowerDeriv(T(26)*y(14),params(7),1);
T(31) = getPowerDeriv(T(12),1-params(8),1);
T(32) = 1/(steady_state(4));
T(33) = (-(T(8)/T(6)*y(15)))/(y(9)*y(9));
T(34) = y(14)*1/y(1);
T(35) = T(25)*T(30)*T(34);
T(36) = T(8)/T(6)/y(9);
T(37) = T(3)*getPowerDeriv(y(10),(-params(4)),1);
T(38) = getPowerDeriv(T(6),(-1),1);
T(39) = y(15)*(-(T(8)*T(37)))/(T(6)*T(6))/y(9);
T(40) = T(5)*getPowerDeriv(y(16),(-params(4)),1);
T(41) = y(15)*T(40)/T(6)/y(9);
T(42) = getPowerDeriv(y(2),params(8),1);
T(43) = (-(T(28)*getPowerDeriv(y(3),params(16),1)));
T(44) = T(28)*getPowerDeriv(y(12),params(16),1);
T(45) = (steady_state(6))*1/T(1)*getPowerDeriv(y(12)/T(1),params(6),1);
T(46) = T(27)*T(45);
T(47) = params(11)/100*T(19);
