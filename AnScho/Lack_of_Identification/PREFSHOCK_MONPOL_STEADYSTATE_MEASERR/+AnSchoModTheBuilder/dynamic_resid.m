...
residual(1) = lhs - rhs;
lhs = 1;
rhs = T(14)*(1-(T(5)/y(15))^(-1))+y(12)*params(14)*(y(12)-T(9))-params(14)/(2*params(5))*T(15)-T(6)*params(14)*y(18)*T(17);
residual(2) = lhs - rhs;
...
residual(7) = lhs - rhs;
lhs = y(6);
rhs = params(3)+100*(log(T(13))-log(T(20))+log(T(21)))+params(18)*x(it_, 5);
residual(8) = lhs - rhs;
lhs = y(7);
rhs = params(2)+400*log(T(22))+params(19)*x(it_, 6);
residual(9) = lhs - rhs;
lhs = y(8);
rhs = params(1)+params(2)+params(3)*4+400*log(T(23))+params(20)*x(it_, 7);
residual(10) = lhs - rhs;
