...
M_.params = NaN(20, 1);
M_.NNZDerivatives = [46; 127; -1; ];
M_.static_tmp_nbr = [8; 13; 3; 0; ];
M_.params( 1 ) = 1;
RA = M_.params( 1 );
M_.params( 2 ) = 3.2;
PA = M_.params( 2 );
...
estim_params_.param_vals = [estim_params_.param_vals; 17, 0.2, 1e-8, 5, 4, 0.3, 2, NaN, NaN, NaN ];
