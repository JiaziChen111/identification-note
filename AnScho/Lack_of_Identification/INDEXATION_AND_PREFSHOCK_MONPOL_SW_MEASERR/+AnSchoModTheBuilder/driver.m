...
M_.exo_names(5) = {'measerr_YGR'};
M_.exo_names_tex(5) = {'{\epsilon^{YGR}}'};
M_.exo_names_long(5) = {'measurement error on YGR'};
M_.exo_names(6) = {'measerr_INFL'};
M_.exo_names_tex(6) = {'{\epsilon^{INFL}}'};
M_.exo_names_long(6) = {'measurement error on INFL'};
M_.exo_names(7) = {'measerr_INT'};
M_.exo_names_tex(7) = {'{\epsilon^{INT}}'};
M_.exo_names_long(7) = {'measurement error on INT'};
...
M_.param_names(8) = {'PSIDY'};
M_.param_names_tex(8) = {'{\psi_{dy}}'};
M_.param_names_long(8) = {'Taylor rule sensitivity parameter to trend output and growth deviations'};
M_.param_names(9) = {'RHOR'};
M_.param_names_tex(9) = {'{\rho_R}'};
M_.param_names_long(9) = {'Taylor rule persistence'};
M_.param_names(10) = {'RHOG'};
M_.param_names_tex(10) = {'{\rho_{g}}'};
M_.param_names_long(10) = {'persistence government spending process'};
M_.param_names(11) = {'RHOZ'};
M_.param_names_tex(11) = {'{\rho_z}'};
M_.param_names_long(11) = {'persistence TFP growth rate process'};
M_.param_names(12) = {'SIGR'};
M_.param_names_tex(12) = {'{\sigma_R}'};
M_.param_names_long(12) = {'standard deviation monetary policy shock'};
M_.param_names(13) = {'SIGG'};
M_.param_names_tex(13) = {'{\sigma_{g}}'};
M_.param_names_long(13) = {'standard deviation government spending process'};
M_.param_names(14) = {'SIGZ'};
M_.param_names_tex(14) = {'{\sigma_z}'};
M_.param_names_long(14) = {'standard deviation TFP growth shock'};
M_.param_names(15) = {'PHI'};
M_.param_names_tex(15) = {'{\phi}'};
M_.param_names_long(15) = {'Rotemberg adjustment cost parameter'};
M_.param_names(16) = {'C_o_Y'};
M_.param_names_tex(16) = {'{\bar{C}/\bar{Y}}'};
M_.param_names_long(16) = {'steady state consumption to output ratio'};
M_.param_names(17) = {'IOTAP'};
M_.param_names_tex(17) = {'{\iota_p}'};
M_.param_names_long(17) = {'partial inflation indexation'};
M_.param_names(18) = {'RHOZETA'};
M_.param_names_tex(18) = {'{\rho_\zeta}'};
M_.param_names_long(18) = {'persistence discount rate shifter'};
M_.param_names(19) = {'SIGZETA'};
M_.param_names_tex(19) = {'{\sigma_\zeta}'};
M_.param_names_long(19) = {'standard deviation discount rate shifter shock'};
M_.param_names(20) = {'SIGYGR'};
M_.param_names_tex(20) = {'{\sigma_{YGR}}'};
M_.param_names_long(20) = {'standard deviation measurement errors YGR'};
M_.param_names(21) = {'SIGINFL'};
M_.param_names_tex(21) = {'{\sigma_{INFL}}'};
M_.param_names_long(21) = {'standard deviation measurement errors INFL'};
M_.param_names(22) = {'SIGINT'};
M_.param_names_tex(22) = {'{\sigma_{INT}}'};
M_.param_names_long(22) = {'standard deviation measurement errors INT'};
...
M_.max_exo_lag_by_var = [0 0 0 0 0 0 0 ];
...
M_.params = NaN(22, 1);
M_.NNZDerivatives = [49; 162; -1; ];
M_.static_tmp_nbr = [10; 34; 5; 0; ];
M_.params( 1 ) = 1;
RA = M_.params( 1 );
M_.params( 2 ) = 3.2;
PA = M_.params( 2 );
...
IOTAP = M_.params( 17 );
M_.params( 18 ) = 0.75;
RHOZETA = M_.params( 18 );
M_.params( 19 ) = 0.2;
SIGZETA = M_.params( 19 );
M_.params( 20 ) = 0.23;
SIGYGR = M_.params( 20 );
M_.params( 21 ) = 0.56;
SIGINFL = M_.params( 21 );
M_.params( 22 ) = 0.66;
SIGINT = M_.params( 22 );
%
% SHOCKS instructions
...
estim_params_.param_vals = [estim_params_.param_vals; 8, 0.2, 1e-5, 10, 2, 0.2, 0.15, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 9, 0.75, 1e-5, 0.99999, 1, 0.5, 0.2, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 10, 0.95, 1e-5, 0.99999, 1, 0.8, 0.1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 11, 0.9, 1e-5, 0.99999, 1, 0.66, 0.15, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 12, 0.2, 1e-8, 5, 4, 0.3, 2, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 13, 0.6, 1e-8, 5, 4, 0.4, 2, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 14, 0.3, 1e-8, 5, 4, 0.4, 2, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 17, 0.5, 1e-8, 0.99999, 1, 0.5, 0.15, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 18, 0.75, 1e-5, 0.99999, 1, 0.5, 0.2, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 19, 0.2, 1e-8, 5, 4, 0.3, 2, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 20, 0.23, 1e-8, 5, 4, 0.3, 2, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 21, 0.56, 1e-8, 5, 4, 0.3, 2, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 22, 0.66, 1e-8, 5, 4, 0.3, 2, NaN, NaN, NaN ];
steady;
resid;                  
