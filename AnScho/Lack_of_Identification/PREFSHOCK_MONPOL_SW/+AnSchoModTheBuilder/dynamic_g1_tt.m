...
T(51) = y(16)*(-(T(9)*T(49)))/(T(7)*T(7))/y(9);
T(52) = (y(18)-T(12))*T(51);
T(53) = getPowerDeriv(y(17),(-params(4)),1);
T(54) = T(6)*T(53);
T(55) = y(16)*T(54)/T(7)/y(9);
T(56) = (y(18)-T(12))*T(55);
T(57) = getPowerDeriv(y(2),params(9),1);
T(58) = (steady_state(6))*1/T(1)*getPowerDeriv(y(12)/T(1),params(6),1);
T(59) = T(29)*T(58);
T(60) = (-(T(27)*T(2)))/(T(3)*T(3));
T(61) = (-(T(31)*T(60)))/(T(32)*T(32));
T(62) = (-(T(27)*y(9)))/(T(2)*T(2));
T(63) = T(28)*T(42)*T(62);
T(64) = T(27)/T(3);
T(65) = (-(T(31)*T(64)))/(T(32)*T(32));
T(66) = y(16)*(-(T(4)*T(9)))/(T(7)*T(7))/y(9);
T(67) = (y(18)-T(12))*T(66);
T(68) = y(16)*T(5)/T(7)/y(9);
T(69) = (y(18)-T(12))*T(68);
T(70) = params(12)/100*T(21);
