...
M_.params = NaN(18, 1);
M_.NNZDerivatives = [44; 140; -1; ];
M_.static_tmp_nbr = [9; 25; 4; 0; ];
M_.params( 1 ) = 1;
RA = M_.params( 1 );
M_.params( 2 ) = 3.2;
PA = M_.params( 2 );
...
estim_params_.param_vals = [estim_params_.param_vals; 18, 0.2, 1e-8, 5, 4, 0.3, 4, NaN, NaN, NaN ];
steady;
resid;                  
