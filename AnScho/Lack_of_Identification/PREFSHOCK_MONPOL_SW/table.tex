...
\hline
$\checkmark\checkmark$ & err & $[\psi_\pi \psi_y \rho_R ]$ & ${YGR},{y},{R}$ \\
\hline
...
\hline
$\checkmark\checkmark$ & err & $[\psi_\pi \psi_y \rho_R ]$ & ${YGR},{c},{R}$ \\
\hline
...
\hline
$\checkmark\checkmark$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${YGR},{R},{\pi}$ \\
\hline
...
\hline
$[\psi_\pi \psi_y \rho_R \sigma_R ]$ & err & $[\psi_\pi \psi_y \sigma_R ]$ & ${c},{z},{\zeta}$ \\
\hline
$[\psi_y ]$ & err & $[\psi_\pi ]$ & ${R},{\pi},{g}$ \\
\hline
$[\psi_y ]$ & err & $[\psi_\pi \rho_R ]$ & ${R},{\pi},{z}$ \\
\hline
$[\psi_y ]$ & err & $[\psi_\pi ]$ & ${R},{\pi},{\zeta}$ \\
\hline
$[\psi_\pi \psi_y \rho_R \sigma_R ]$ & err & $[\psi_\pi \psi_y \rho_R ]$ & ${R},{g},{z}$ \\
\hline
$[\psi_\pi \psi_y \rho_R \sigma_R ]$ & err & $[\psi_\pi \psi_y \rho_R ]$ & ${R},{g},{\zeta}$ \\
\hline
$[\psi_\pi \psi_y \rho_R \sigma_R ]$ & err & $[\psi_\pi \psi_y \rho_R ]$ & ${R},{z},{\zeta}$ \\
\hline
...
\hline
$[\psi_\pi \psi_y \rho_R \sigma_R ]$ & err & $[\psi_\pi \sigma_R ]$ & ${\pi},{z},{\zeta}$ \\
\hline
$[\psi_\pi \psi_y \rho_R \sigma_R ]$ & err & $[\psi_\pi \psi_y \rho_R \sigma_R ]$ & ${g},{z},{\zeta}$ \\
\hline
\caption{PREFSHOCK MONPOL SW}
