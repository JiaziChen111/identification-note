...
residual(6) = lhs - rhs;
lhs = y(6);
rhs = params(3)+100*(log(T(21))-log(T(22))+log(T(23)))+params(17)*x(it_, 4);
residual(7) = lhs - rhs;
lhs = y(7);
rhs = params(2)+400*log(T(24))+params(18)*x(it_, 5);
residual(8) = lhs - rhs;
lhs = y(8);
rhs = params(1)+params(2)+params(3)*4+400*log(T(25))+params(19)*x(it_, 6);
residual(9) = lhs - rhs;
