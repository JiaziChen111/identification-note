...
T(27) = y(10)*T(26)/y(10);
T(28) = getPowerDeriv(T(5)/y(10),(-1),1);
T(29) = y(4)*(T(5)*T(4)*T(26)-T(7)*y(10)*T(26))/(T(5)*T(5))/y(4);
T(30) = (y(7)-T(10))*T(29);
...
T(35) = 1-(T(25)*T(33)+T(24)*T(34));
T(36) = 1/T(1)*getPowerDeriv(y(7)/T(1),params(6),1);
T(37) = (-1)/(y(8)*y(8));
T(38) = getPowerDeriv(y(9),params(7),1);
T(39) = (y(10)*T(2)-T(5))/(y(10)*y(10));
T(40) = y(4)*(T(3)*T(5)-T(2)*T(7))/(T(5)*T(5))/y(4);
T(41) = (y(7)-T(10))*T(40);
