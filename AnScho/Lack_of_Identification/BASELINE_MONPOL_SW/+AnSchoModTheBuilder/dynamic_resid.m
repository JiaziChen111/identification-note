...
residual(1) = lhs - rhs;
lhs = 1;
rhs = 1/params(5)*(1-T(8)^(-1))+y(11)*params(15)*(y(11)-T(12))-params(15)/(2*params(5))*(y(11)-T(13))^2+T(9)*params(15)*y(16)*T(17);
residual(2) = lhs - rhs;
lhs = y(8)-y(8)*T(18);
...
residual(4) = lhs - rhs;
lhs = log(y(12));
rhs = (1-params(10))*log(T(15))+params(10)*log(y(3))+params(13)/100*x(it_, 2);
residual(5) = lhs - rhs;
lhs = log(y(13));
