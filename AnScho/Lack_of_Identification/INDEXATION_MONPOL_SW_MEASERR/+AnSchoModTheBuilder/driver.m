...
M_.exo_names(4) = {'measerr_YGR'};
M_.exo_names_tex(4) = {'{\epsilon^{YGR}}'};
M_.exo_names_long(4) = {'measurement error on YGR'};
M_.exo_names(5) = {'measerr_INFL'};
M_.exo_names_tex(5) = {'{\epsilon^{INFL}}'};
M_.exo_names_long(5) = {'measurement error on INFL'};
M_.exo_names(6) = {'measerr_INT'};
M_.exo_names_tex(6) = {'{\epsilon^{INT}}'};
M_.exo_names_long(6) = {'measurement error on INT'};
...
M_.param_names(18) = {'SIGYGR'};
M_.param_names_tex(18) = {'{\sigma_{YGR}}'};
M_.param_names_long(18) = {'standard deviation measurement errors YGR'};
M_.param_names(19) = {'SIGINFL'};
M_.param_names_tex(19) = {'{\sigma_{INFL}}'};
M_.param_names_long(19) = {'standard deviation measurement errors INFL'};
M_.param_names(20) = {'SIGINT'};
M_.param_names_tex(20) = {'{\sigma_{INT}}'};
M_.param_names_long(20) = {'standard deviation measurement errors INT'};
...
M_.max_exo_lag_by_var = [0 0 0 0 0 0 ];
...
M_.params = NaN(20, 1);
M_.NNZDerivatives = [42; 123; -1; ];
M_.static_tmp_nbr = [9; 30; 4; 0; ];
M_.params( 1 ) = 1;
RA = M_.params( 1 );
M_.params( 2 ) = 3.2;
PA = M_.params( 2 );
...
estim_params_.param_vals = [estim_params_.param_vals; 18, 0.23, 1e-8, 5, 4, 0.3, 2, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 19, 0.56, 1e-8, 5, 4, 0.3, 2, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 20, 0.66, 1e-8, 5, 4, 0.3, 2, NaN, NaN, NaN ];
steady;
resid;                  
