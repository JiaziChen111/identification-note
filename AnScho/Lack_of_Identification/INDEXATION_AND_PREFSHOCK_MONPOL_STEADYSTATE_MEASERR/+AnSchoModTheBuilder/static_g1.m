...
g1 = zeros(10, 10);
g1(1,5)=y(10)*T(30)-y(6)*T(6)*T(4)*T(30)/y(7)/(T(8)*y(9));
...
g1(2,5)=(-(T(13)*(-(T(31)*T(32)))-T(6)*params(14)*y(7)*T(34)));
g1(2,7)=(-(params(14)*(y(7)-T(9))+y(7)*params(14)*T(38)-params(14)/(2*params(5))*T(38)*2*(y(7)-T(9))-T(6)*params(14)*(T(16)+y(7)*T(15)*T(38))));
g1(2,10)=(-(T(13)*(-(T(32)*T(42)))-T(6)*params(14)*y(7)*T(44)));
g1(3,4)=1-T(14)*params(14)/2-(1-1/y(8));
g1(3,5)=(-1);
g1(3,7)=(-(y(4)*params(14)/2*T(38)*2*(y(7)-T(9))));
g1(3,8)=(-(y(4)*(-T(41))));
g1(4,4)=(-(exp(params(11)*x(1))*T(18)*T(28)*T(29)));
g1(4,6)=1-exp(params(11)*x(1))*(T(18)*T(29)*T(22)*T(23)+T(17)*T(35));
g1(4,7)=(-(exp(params(11)*x(1))*T(18)*T(29)*T(23)*T(40)));
